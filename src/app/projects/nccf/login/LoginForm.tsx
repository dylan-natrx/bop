...
/**
 * Credential form for the nccf tenant's gate. Submits to /api/auth/login;
...
export function LoginForm() {
  ...
  return (
    <form onSubmit={onSubmit} className="nccf-login-form" noValidate>
      <div className="nccf-field">
      ...
      {error ? (
        <div role="alert" className="nccf-error">
          {error}
        </div>
      ) : null}
