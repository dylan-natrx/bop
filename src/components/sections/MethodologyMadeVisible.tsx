      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
        ...
        <div className="
          ...
          <p>
            ...
            <em className="font-serif italic">Natrx Assess</em>. The result is
            the first harbor-wide comparative look at all 78 candidate sites at
            once, calibrated to the specific ecology and geography of New York
            Harbor. The walkthrough below shows the analysis in the order it
            was built: water quality variables first, producing the ranking;
            then the wave and shoreline change data from Natrx Assess; then
            the operational filters that determine which suitable sites are
            also actionable.
          </p>
        </div>
      </div>
